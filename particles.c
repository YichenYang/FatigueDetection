...
*/
void display_particle(/* IplImage* img, */particle p, CvPoint *point1, CvPoint *point2)
{
  int x0, y0, x1, y1;
...
//   cvRectangle( img, cvPoint( x0*4, y0 ), cvPoint( x1*4, y1 ), CV_RGB(255,255,255), 2, 8, 0 );
// 	cvLine(img, cvPoint(point->x - width, point->y), cvPoint(point->x + width, point->y), CV_RGB(0, 255, 0), 2, 8, 0);
// 	cvLine(img, cvPoint(point->x, point->y - (width / 2)), cvPoint(point->x, point->y + (width / 2)), CV_RGB(0, 255, 0), 2, 8, 0);
